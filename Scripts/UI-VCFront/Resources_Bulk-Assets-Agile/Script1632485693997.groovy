...
for (int i; i < urls.size(); i++) {
    ...
    WebUI.navigateToUrl(GlobalVariable.urlFrontQA + '/' + urls.get(i))
	...
	if (urls.get(i) == urls[0]) {
		...
		assert WebUI.getUrl() == (GlobalVariable.urlFrontQA + '/agile-download-thank-you')
	} else {
		...
		assert WebUI.getUrl() == (GlobalVariable.urlFrontQA + '/agile-inq-thank-you')		
	}
