...
WebUI.navigateToUrl(GlobalVariable.urlFrontQA + '/partner-form-find-solution-partner')
...
WebUI.setText(findTestObject('UI/UI-VCFront/main_Call_form_objects/input_Phone'), '12345678901')
...
assert WebUI.getUrl() == (GlobalVariable.urlFrontQA + '/partner-thank-you')
