...
uploadFileUrl = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Platform/AssetFileUpload', [
	('folderUrl') : folderUrl,
	('url') : GlobalVariable.urlBackQA + '/images/userpic.svg'
	]))
...
'CREATE NEW PRODUCT'
productCreate = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Catalog/ProductUpdate', [
	('name') : productName
	]))
