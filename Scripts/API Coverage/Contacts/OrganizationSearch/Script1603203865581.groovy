...
response = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Customer/Organizations/OrganizationsSearch', [('searchPhrase') : GlobalVariable.contactFirstName] ))
