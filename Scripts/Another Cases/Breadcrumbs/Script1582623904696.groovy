...
WebUI.navigateToUrl(GlobalVariable.urlFrontQA + '/en-US/camcorders/aerial-imaging-drones/3dr-solo-quadcopter-no-gimbal')
...
String ExpectedUrl = GlobalVariable.urlFrontQA + '/en-US/camcorders'
...
String ExpectedUrlHome = GlobalVariable.urlFrontQA + '/en-US/'
